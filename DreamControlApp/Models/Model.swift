...
let quotes: [DailyRectangle] = [
    ...
    DailyRectangle(text: "Границ для мечты не существует, дерзай", authorText: "Эллен Джонсон Сирлиф"),
    ...
    DailyRectangle(text: "Смело иди за своей мечтой и не сдавайся", authorText: "Ханс Кристиан Андерсен"),
    ...
    DailyRectangle(text: "Живи своей мечтой, не бойся падений", authorText: "Ральф Уолдо Эмерсон"),
    ...
    DailyRectangle(text: "Живи тем, что искренне любишь", authorText: "Антуан де Сент-Экзюпери"),
    ...
    DailyRectangle(text: "Будь мечтой своей жизни, живи ею", authorText: "Карл Густав Юнг"),
    DailyRectangle(text: "Твори мечту с уверенностью в успехе", authorText: "Винсент Ван Гог"),
